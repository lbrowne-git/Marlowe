...
namespace Marlowe.Visitor
{
    /** Details
      ...
      */
    public abstract class NamespaceVisitor : INamespaceVisitor<object>
    {
        #region Namespace
        //   namespace_member_declarations
        //:       namespace_member_declaration                      
        public object VisitNamespace_member_declarations([NotNull] CSharpParser.Namespace_member_declarationsContext context){
        ...
        //| type_declaration
        //;
        public object VisitNamespace_member_declaration([NotNull] CSharpParser.Namespace_member_declarationContext context){
        ...
        public object VisitNamespace_declaration([NotNull] CSharpParser.Namespace_declarationContext context)
        {
            if (!context.IsEmpty)
            {
        ...
        public object VisitNamespace_body([NotNull] CSharpParser.Namespace_bodyContext context)
        {
