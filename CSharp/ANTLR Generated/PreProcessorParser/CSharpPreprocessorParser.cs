	...
	public Preprocessor_directiveContext preprocessor_directive() {
		...
		try {
			...
			case DEFINE:
				...
				State = 7; Match(CONDITIONAL_SYMBOL);
			...
			case UNDEF:
				...
				State = 12; Match(CONDITIONAL_SYMBOL);
			...
			case NULLABLE:
				...
				State = 76; Match(TEXT);
				State = 77; directive_new_line_or_sharp();
	...
	private Preprocessor_expressionContext preprocessor_expression(int _p) {
		...
		try {
			...
			case CONDITIONAL_SYMBOL:
				{
				State = 89; Match(CONDITIONAL_SYMBOL);
			...
			case OPEN_PARENS:
				...
				State = 92; _localctx.expr = preprocessor_expression(0);
			...
			case BANG:
				{
				State = 96; Match(BANG);
				State = 97; _localctx.expr = preprocessor_expression(5);
			...
			while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						State = 104; _localctx.expr2 = preprocessor_expression(5);
					...
					case 2:
						...
						State = 109; _localctx.expr2 = preprocessor_expression(4);
					...
					case 3:
						...
						State = 114; _localctx.expr2 = preprocessor_expression(3);
					...
					case 4:
						...
						State = 119; _localctx.expr2 = preprocessor_expression(2);
