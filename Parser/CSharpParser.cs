...
public partial class CSharpParser : CSharpParserBase {
	...
	public Local_variable_declarationContext local_variable_declaration() {
		...
		try {
			...
			case FIXED:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1440; Match(FIXED);
				State = 1441; pointer_type();
				State = 1442; fixed_pointer_declarators();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Local_variable_declaratorContext local_variable_declarator() {
		...
		try {
			...
			case 1:
				{
				State = 1451; Match(ASSIGNMENT);
				State = 1453;
				ErrorHandler.Sync(this);
				switch ( Interpreter.AdaptivePredict(TokenStream,149,Context) ) {
				case 1:
					{
					State = 1452; Match(REF);
					}
					break;
				}
				State = 1455; local_variable_initializer();
				}
				break;
			}
			}
	...
	public Local_variable_initializerContext local_variable_initializer() {
		...
		try {
			...
			case OP_RANGE:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1458; expression();
				}
				break;
			case OPEN_BRACE:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1459; array_initializer();
				}
				break;
			case STACKALLOC:
				EnterOuterAlt(_localctx, 3);
				{
				State = 1460; stackalloc_initializer();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Local_constant_declarationContext local_constant_declaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1463; Match(CONST);
			State = 1464; type_();
			State = 1465; constant_declarators();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public If_bodyContext if_body() {
		...
		try {
			...
			case OP_RANGE:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1468; simple_embedded_statement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Switch_labelContext switch_label() {
		...
		try {
			...
			case CASE:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1478; Match(CASE);
				State = 1479; expression();
				State = 1481;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==WHEN) {
					{
					State = 1480; case_guard();
					}
				}
	...
	public Case_guardContext case_guard() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1489; Match(WHEN);
			State = 1490; expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public For_initializerContext for_initializer() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1497; local_variable_declaration();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
	...
	public Catch_clausesContext catch_clauses() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1516; specific_catch_clause();
				State = 1520;
				ErrorHandler.Sync(this);
				...
				while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						{
						{
						State = 1517; specific_catch_clause();
						}
						} 
					}
					State = 1522;
				...
				if (_la==CATCH) {
					{
					State = 1523; general_catch_clause();
					}
				}
			...
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1526; general_catch_clause();
				}
				break;
			}
		}
	...
	public Specific_catch_clauseContext specific_catch_clause() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1529; Match(CATCH);
			State = 1530; Match(OPEN_PARENS);
			State = 1531; class_type();
			State = 1533;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BY) | (1L << DESCENDING) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INTO) | (1L << JOIN) | (1L << LET))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (PARTIAL - 64)) | (1L << (REMOVE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (UNMANAGED - 64)) | (1L << (VAR - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)))) != 0)) {
				{
				State = 1532; identifier();
				}
			}
	...
	public General_catch_clauseContext general_catch_clause() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1541; Match(CATCH);
			State = 1543;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==WHEN) {
				{
				State = 1542; exception_filter();
				}
			}
	...
	public Exception_filterContext exception_filter() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1547; Match(WHEN);
			State = 1548; Match(OPEN_PARENS);
			State = 1549; expression();
			State = 1550; Match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Resource_acquisitionContext resource_acquisition() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1555; local_variable_declaration();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
	...
	public Namespace_declarationContext namespace_declaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1559; Match(NAMESPACE);
			State = 1560; _localctx.qi = qualified_identifier();
			State = 1561; namespace_body();
			State = 1563;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==SEMICOLON) {
				{
				State = 1562; Match(SEMICOLON);
				}
			}
	...
	public Namespace_bodyContext namespace_body() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1573; Match(OPEN_BRACE);
			State = 1575;
			ErrorHandler.Sync(this);
			switch ( Interpreter.AdaptivePredict(TokenStream,169,Context) ) {
			case 1:
				{
				State = 1574; extern_alias_directives();
				}
				break;
			}
			State = 1578;
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ABSTRACT) | (1L << ASYNC) | (1L << CLASS) | (1L << DELEGATE) | (1L << ENUM) | (1L << EXTERN) | (1L << INTERFACE) | (1L << INTERNAL))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (NAMESPACE - 65)) | (1L << (NEW - 65)) | (1L << (OVERRIDE - 65)) | (1L << (PARTIAL - 65)) | (1L << (PRIVATE - 65)) | (1L << (PROTECTED - 65)) | (1L << (PUBLIC - 65)) | (1L << (READONLY - 65)) | (1L << (REF - 65)) | (1L << (SEALED - 65)) | (1L << (STATIC - 65)) | (1L << (STRUCT - 65)) | (1L << (UNSAFE - 65)) | (1L << (VIRTUAL - 65)) | (1L << (VOLATILE - 65)) | (1L << (OPEN_BRACKET - 65)))) != 0)) {
				{
				State = 1580; namespace_member_declarations();
				}
			}

			State = 1583; Match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					State = 1585; extern_alias_directive();
					}
					}
					break;
				default:
	...
	public Extern_alias_directiveContext extern_alias_directive() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1590; Match(EXTERN);
			State = 1591; Match(ALIAS);
			State = 1592; identifier();
			State = 1593; Match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Using_directiveContext using_directive() {
		...
		try {
			...
			case 1:
				...
				EnterOuterAlt(_localctx, 1);
				{
				State = 1600; Match(USING);
				State = 1601; identifier();
				State = 1602; Match(ASSIGNMENT);
				State = 1603; namespace_or_type_name();
				State = 1604; Match(SEMICOLON);
				}
				break;
			case 2:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 1606; Match(USING);
				State = 1607; namespace_or_type_name();
				State = 1608; Match(SEMICOLON);
				}
				break;
			case 3:
				...
				EnterOuterAlt(_localctx, 3);
				{
				State = 1610; Match(USING);
				State = 1611; Match(STATIC);
				State = 1612; namespace_or_type_name();
	...
	public Namespace_member_declarationsContext namespace_member_declarations() {
		...
		try {
			...
			do {
				{
				{
				State = 1617; namespace_member_declaration();
				}
				}
				State = 1620;
				ErrorHandler.Sync(this);
	...
	public Namespace_member_declarationContext namespace_member_declaration() {
		...
		try {
			...
			case NAMESPACE:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1622; namespace_declaration();
				}
				break;
			case ABSTRACT:
			case ASYNC:
	...
	public Type_declarationContext type_declaration() {
		...
		try {
			...
			case 1:
				{
				State = 1629; all_member_modifiers();
				}
				break;
			}
			State = 1637;
			...
			case STRUCT:
				{
				State = 1633; struct_definition();
				}
				break;
			case INTERFACE:
				{
				State = 1634; interface_definition();
				}
				break;
			case ENUM:
				{
				State = 1635; enum_definition();
				}
				break;
			case DELEGATE:
				{
				State = 1636; delegate_definition();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Class_baseContext class_base() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1661; Match(COLON);
			State = 1662; class_type();
			State = 1667;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while (_la==COMMA) {
				...
				State = 1664; namespace_or_type_name();
				}
				}
				State = 1669;
				ErrorHandler.Sync(this);
	...
	public Interface_type_listContext interface_type_list() {
		...
		try {
			...
			while (_la==COMMA) {
				...
				State = 1672; namespace_or_type_name();
				}
				}
				State = 1677;
				ErrorHandler.Sync(this);
	...
	public Type_parameter_constraints_clausesContext type_parameter_constraints_clauses() {
		...
		try {
			...
			do {
				{
				{
				State = 1678; type_parameter_constraints_clause();
				}
				}
				State = 1681;
				ErrorHandler.Sync(this);
	...
	public Type_parameter_constraints_clauseContext type_parameter_constraints_clause() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1683; Match(WHERE);
			State = 1684; identifier();
			State = 1685; Match(COLON);
			State = 1686; type_parameter_constraints();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Type_parameter_constraintsContext type_parameter_constraints() {
		...
		try {
			...
			case NEW:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1688; constructor_constraint();
				}
				break;
			case ADD:
			case ALIAS:
			...
			case IDENTIFIER:
				...
				case 1:
					...
					State = 1691; secondary_constraints();
					}
					break;
				}
				State = 1696;
				...
				if (_la==COMMA) {
					...
					State = 1695; constructor_constraint();
					}
				}
	...
	public Primary_constraintContext primary_constraint() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1700; class_type();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1701; Match(CLASS);
				State = 1703;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==INTERR) {
					{
					State = 1702; Match(INTERR);
					}
				}
			...
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 1705; Match(STRUCT);
				}
				break;
			case 4:
				EnterOuterAlt(_localctx, 4);
				{
				State = 1706; Match(UNMANAGED);
				}
				break;
			}
		}
		...
		try {
			...
			while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					State = 1711; namespace_or_type_name();
					}
					} 
				}
				State = 1716;
	...
	public Constructor_constraintContext constructor_constraint() {
		...
		try {
			...
			State = 1718; Match(OPEN_PARENS);
			State = 1719; Match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Class_bodyContext class_body() {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ABSTRACT) | (1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CLASS) | (1L << CONST) | (1L << DECIMAL) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << ENUM) | (1L << EQUALS) | (1L << EVENT) | (1L << EXPLICIT) | (1L << EXTERN) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << IMPLICIT) | (1L << INT) | (1L << INTERFACE) | (1L << INTERNAL) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (OVERRIDE - 64)) | (1L << (PARTIAL - 64)) | (1L << (PRIVATE - 64)) | (1L << (PROTECTED - 64)) | (1L << (PUBLIC - 64)) | (1L << (READONLY - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SEALED - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (STATIC - 64)) | (1L << (STRING - 64)) | (1L << (STRUCT - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNMANAGED - 64)) | (1L << (UNSAFE - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (VIRTUAL - 64)) | (1L << (VOID - 64)) | (1L << (VOLATILE - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (OPEN_BRACKET - 64)))) != 0) || _la==OPEN_PARENS || _la==TILDE) {
				{
				State = 1722; class_member_declarations();
				}
			}

			State = 1725; Match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Class_member_declarationsContext class_member_declarations() {
		...
		try {
			...
			do {
				{
				{
				State = 1727; class_member_declaration();
				}
				}
				State = 1730;
				ErrorHandler.Sync(this);
	...
	public Class_member_declarationContext class_member_declaration() {
		...
		try {
			...
			case 1:
				{
				State = 1735; all_member_modifiers();
				}
				break;
			}
			State = 1740;
			...
			case OPEN_PARENS:
				{
				State = 1738; common_member_declaration();
				}
				break;
			case TILDE:
				{
				State = 1739; destructor_definition();
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			do {
				...
				case 1:
					{
					{
					State = 1742; all_member_modifier();
					}
					}
					break;
				default:
	...
	public Common_member_declarationContext common_member_declaration() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1749; constant_declaration();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1750; typed_member_declaration();
				}
				break;
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 1751; event_declaration();
				}
				break;
			case 4:
				EnterOuterAlt(_localctx, 4);
				{
				State = 1752; conversion_operator_declarator();
				State = 1758;
				ErrorHandler.Sync(this);
				switch (TokenStream.LA(1)) {
				case OPEN_BRACE:
				...
				case ASSIGNMENT:
					{
					State = 1754; right_arrow();
					State = 1755; throwable_expression();
					State = 1756; Match(SEMICOLON);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			case 5:
				EnterOuterAlt(_localctx, 5);
				{
				State = 1760; constructor_declaration();
				}
				break;
			case 6:
				EnterOuterAlt(_localctx, 6);
				{
				State = 1761; Match(VOID);
				State = 1762; method_declaration();
				}
				break;
			case 7:
				EnterOuterAlt(_localctx, 7);
				{
				State = 1763; class_definition();
				}
				break;
			case 8:
				EnterOuterAlt(_localctx, 8);
				{
				State = 1764; struct_definition();
				}
				break;
			case 9:
				EnterOuterAlt(_localctx, 9);
				{
				State = 1765; interface_definition();
				}
				break;
			case 10:
				EnterOuterAlt(_localctx, 10);
				{
				State = 1766; enum_definition();
				}
				break;
			case 11:
				EnterOuterAlt(_localctx, 11);
				{
				State = 1767; delegate_definition();
				}
				break;
			}
		}
	...
	public Typed_member_declarationContext typed_member_declaration() {
		...
		try {
			...
			case 2:
				{
				State = 1771; Match(READONLY);
				State = 1772; Match(REF);
				}
				break;
			case 3:
				{
				State = 1773; Match(REF);
				State = 1774; Match(READONLY);
				}
				break;
			}
			State = 1777; type_();
			...
			case 1:
				{
				State = 1778; namespace_or_type_name();
				State = 1779; Match(DOT);
				State = 1780; indexer_declaration();
				}
				break;
			case 2:
				{
				State = 1782; method_declaration();
				}
				break;
			case 3:
				{
				State = 1783; property_declaration();
				}
				break;
			case 4:
				{
				State = 1784; indexer_declaration();
				}
				break;
			case 5:
				{
				State = 1785; operator_declaration();
				}
				break;
			case 6:
				{
				State = 1786; field_declaration();
				}
				break;
			}
			}
	...
	public Constant_declaratorsContext constant_declarators() {
		...
		try {
			...
			while (_la==COMMA) {
				...
				State = 1791; constant_declarator();
				}
				}
				State = 1796;
				ErrorHandler.Sync(this);
	...
	public Variable_declaratorsContext variable_declarators() {
		...
		try {
			...
			while (_la==COMMA) {
				...
				State = 1803; variable_declarator();
				}
				}
				State = 1808;
				ErrorHandler.Sync(this);
	...
	public Variable_declaratorContext variable_declarator() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1809; identifier();
			State = 1812;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==ASSIGNMENT) {
				{
				State = 1810; Match(ASSIGNMENT);
				State = 1811; variable_initializer();
				}
			}
	...
	public Member_nameContext member_name() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1822; namespace_or_type_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Formal_parameter_listContext formal_parameter_list() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1828; parameter_array();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1829; fixed_parameters();
				State = 1832;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==COMMA) {
		...
		try {
			...
			case 1:
				...
				if (((((_la - 54)) & ~0x3f) == 0 && ((1L << (_la - 54)) & ((1L << (IN - 54)) | (1L << (OUT - 54)) | (1L << (REF - 54)) | (1L << (THIS - 54)))) != 0)) {
					{
					State = 1847; parameter_modifier();
					}
				}

				State = 1850; arg_declaration();
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1851; Match(ARGLIST);
				}
				break;
			}
		}
	...
	public Parameter_modifierContext parameter_modifier() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1854; Match(REF);
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1855; Match(OUT);
				}
				break;
			case 3:
				EnterOuterAlt(_localctx, 3);
			...
			case 5:
				...
				{
				State = 1859; Match(IN);
				State = 1860; Match(THIS);
				}
				break;
			case 6:
				EnterOuterAlt(_localctx, 6);
				{
				State = 1861; Match(THIS);
				}
				break;
			}
		}
	...
	public Parameter_arrayContext parameter_array() {
		...
		try {
			...
			if (_la==OPEN_BRACKET) {
				{
				State = 1864; attributes();
				}
			}

			State = 1867; Match(PARAMS);
			State = 1868; array_type();
	...
	public Accessor_declarationsContext accessor_declarations() {
		...
		try {
			...
			if (_la==OPEN_BRACKET) {
				{
				State = 1871; _localctx.attrs = attributes();
				}
			}
			...
			if (((((_la - 57)) & ~0x3f) == 0 && ((1L << (_la - 57)) & ((1L << (INTERNAL - 57)) | (1L << (PRIVATE - 57)) | (1L << (PROTECTED - 57)))) != 0)) {
				{
				State = 1874; _localctx.mods = accessor_modifier();
				}
			}
	...
	public Get_accessor_declarationContext get_accessor_declaration() {
		...
		try {
			...
			if (((((_la - 57)) & ~0x3f) == 0 && ((1L << (_la - 57)) & ((1L << (INTERNAL - 57)) | (1L << (PRIVATE - 57)) | (1L << (PROTECTED - 57)))) != 0)) {
				{
				State = 1892; accessor_modifier();
				}
			}

			State = 1895; Match(GET);
			State = 1896; accessor_body();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Set_accessor_declarationContext set_accessor_declaration() {
		...
		try {
			...
			if (((((_la - 57)) & ~0x3f) == 0 && ((1L << (_la - 57)) & ((1L << (INTERNAL - 57)) | (1L << (PRIVATE - 57)) | (1L << (PROTECTED - 57)))) != 0)) {
				{
				State = 1901; accessor_modifier();
				}
			}

			State = 1904; Match(SET);
			State = 1905; accessor_body();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Accessor_modifierContext accessor_modifier() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1907; Match(PROTECTED);
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1908; Match(INTERNAL);
				}
				break;
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 1909; Match(PRIVATE);
				}
				break;
			case 4:
				EnterOuterAlt(_localctx, 4);
				{
				State = 1910; Match(PROTECTED);
				State = 1911; Match(INTERNAL);
				}
				break;
			case 5:
				EnterOuterAlt(_localctx, 5);
				{
				State = 1912; Match(INTERNAL);
				State = 1913; Match(PROTECTED);
				}
				break;
			}
		}
	...
	public Event_accessor_declarationsContext event_accessor_declarations() {
		...
		try {
			...
			case ADD:
				{
				State = 1923; Match(ADD);
				State = 1924; block();
				State = 1925; remove_accessor_declaration();
				}
				break;
			case REMOVE:
				{
				State = 1927; Match(REMOVE);
				State = 1928; block();
				State = 1929; add_accessor_declaration();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Add_accessor_declarationContext add_accessor_declaration() {
		...
		try {
			...
			if (_la==OPEN_BRACKET) {
				{
				State = 1933; attributes();
				}
			}

			State = 1936; Match(ADD);
			State = 1937; block();
			}
		}
		catch (RecognitionException re) {
	...
	public Remove_accessor_declarationContext remove_accessor_declaration() {
		...
		try {
			...
			if (_la==OPEN_BRACKET) {
				{
				State = 1939; attributes();
				}
			}

			State = 1942; Match(REMOVE);
			State = 1943; block();
			}
		}
		catch (RecognitionException re) {
	...
	public Overloadable_operatorContext overloadable_operator() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 1945; Match(PLUS);
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 1946; Match(MINUS);
				}
				break;
			case 3:
				EnterOuterAlt(_localctx, 3);
				{
				State = 1947; Match(BANG);
				}
				break;
			case 4:
				EnterOuterAlt(_localctx, 4);
				{
				State = 1948; Match(TILDE);
				}
				break;
			case 5:
				EnterOuterAlt(_localctx, 5);
				{
				State = 1949; Match(OP_INC);
				}
				break;
			case 6:
				EnterOuterAlt(_localctx, 6);
				{
				State = 1950; Match(OP_DEC);
				}
				break;
			case 7:
				EnterOuterAlt(_localctx, 7);
				{
				State = 1951; Match(TRUE);
				}
				break;
			case 8:
				EnterOuterAlt(_localctx, 8);
				{
				State = 1952; Match(FALSE);
				}
				break;
			case 9:
				EnterOuterAlt(_localctx, 9);
			...
			case 10:
				EnterOuterAlt(_localctx, 10);
				{
				State = 1954; Match(DIV);
				}
				break;
			case 11:
				EnterOuterAlt(_localctx, 11);
				{
				State = 1955; Match(PERCENT);
				}
				break;
			case 12:
				EnterOuterAlt(_localctx, 12);
				{
				State = 1956; Match(AMP);
				}
				break;
			case 13:
				EnterOuterAlt(_localctx, 13);
				{
				State = 1957; Match(BITWISE_OR);
				}
				break;
			case 14:
				EnterOuterAlt(_localctx, 14);
				{
				State = 1958; Match(CARET);
				}
				break;
			case 15:
				EnterOuterAlt(_localctx, 15);
				{
				State = 1959; Match(OP_LEFT_SHIFT);
				}
				break;
			case 16:
				EnterOuterAlt(_localctx, 16);
				{
				State = 1960; right_shift();
				}
				break;
			case 17:
				EnterOuterAlt(_localctx, 17);
				{
				State = 1961; Match(OP_EQ);
				}
				break;
			case 18:
				EnterOuterAlt(_localctx, 18);
				{
				State = 1962; Match(OP_NE);
				}
				break;
			case 19:
				EnterOuterAlt(_localctx, 19);
			...
			case 21:
				EnterOuterAlt(_localctx, 21);
				{
				State = 1965; Match(OP_GE);
				}
				break;
			case 22:
				EnterOuterAlt(_localctx, 22);
				{
				State = 1966; Match(OP_LE);
				}
				break;
			}
		}
	...
	public Conversion_operator_declaratorContext conversion_operator_declarator() {
		...
		try {
			...
			State = 1970; Match(OPERATOR);
			State = 1971; type_();
			State = 1972; Match(OPEN_PARENS);
			State = 1973; arg_declaration();
			State = 1974; Match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Constructor_initializerContext constructor_initializer() {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << IN) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (NULL_ - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (OUT - 64)) | (1L << (PARTIAL - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (SIZEOF - 64)) | (1L << (STRING - 64)) | (1L << (THIS - 64)) | (1L << (TRUE - 64)) | (1L << (TYPEOF - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNCHECKED - 64)) | (1L << (UNMANAGED - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (VOID - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (LITERAL_ACCESS - 64)) | (1L << (INTEGER_LITERAL - 64)) | (1L << (HEX_INTEGER_LITERAL - 64)) | (1L << (BIN_INTEGER_LITERAL - 64)) | (1L << (REAL_LITERAL - 64)) | (1L << (CHARACTER_LITERAL - 64)) | (1L << (REGULAR_STRING - 64)) | (1L << (VERBATIUM_STRING - 64)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 64)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (OPEN_PARENS - 129)) | (1L << (PLUS - 129)) | (1L << (MINUS - 129)) | (1L << (STAR - 129)) | (1L << (AMP - 129)) | (1L << (CARET - 129)) | (1L << (BANG - 129)) | (1L << (TILDE - 129)) | (1L << (OP_INC - 129)) | (1L << (OP_DEC - 129)) | (1L << (OP_RANGE - 129)))) != 0)) {
				{
				State = 1979; argument_list();
				}
			}

			State = 1982; Match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Struct_interfacesContext struct_interfaces() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 1988; Match(COLON);
			State = 1989; interface_type_list();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Struct_bodyContext struct_body() {
		...
		try {
			...
			while (((((_la - 9)) & ~0x3f) == 0 && ((1L << (_la - 9)) & ((1L << (ABSTRACT - 9)) | (1L << (ADD - 9)) | (1L << (ALIAS - 9)) | (1L << (ARGLIST - 9)) | (1L << (ASCENDING - 9)) | (1L << (ASYNC - 9)) | (1L << (AWAIT - 9)) | (1L << (BOOL - 9)) | (1L << (BY - 9)) | (1L << (BYTE - 9)) | (1L << (CHAR - 9)) | (1L << (CLASS - 9)) | (1L << (CONST - 9)) | (1L << (DECIMAL - 9)) | (1L << (DELEGATE - 9)) | (1L << (DESCENDING - 9)) | (1L << (DOUBLE - 9)) | (1L << (DYNAMIC - 9)) | (1L << (ENUM - 9)) | (1L << (EQUALS - 9)) | (1L << (EVENT - 9)) | (1L << (EXPLICIT - 9)) | (1L << (EXTERN - 9)) | (1L << (FIXED - 9)) | (1L << (FLOAT - 9)) | (1L << (FROM - 9)) | (1L << (GET - 9)) | (1L << (GROUP - 9)) | (1L << (IMPLICIT - 9)) | (1L << (INT - 9)) | (1L << (INTERFACE - 9)) | (1L << (INTERNAL - 9)) | (1L << (INTO - 9)) | (1L << (JOIN - 9)) | (1L << (LET - 9)) | (1L << (LONG - 9)) | (1L << (NAMEOF - 9)) | (1L << (NEW - 9)) | (1L << (OBJECT - 9)) | (1L << (ON - 9)) | (1L << (ORDERBY - 9)))) != 0) || ((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & ((1L << (OVERRIDE - 73)) | (1L << (PARTIAL - 73)) | (1L << (PRIVATE - 73)) | (1L << (PROTECTED - 73)) | (1L << (PUBLIC - 73)) | (1L << (READONLY - 73)) | (1L << (REF - 73)) | (1L << (REMOVE - 73)) | (1L << (SBYTE - 73)) | (1L << (SEALED - 73)) | (1L << (SELECT - 73)) | (1L << (SET - 73)) | (1L << (SHORT - 73)) | (1L << (STATIC - 73)) | (1L << (STRING - 73)) | (1L << (STRUCT - 73)) | (1L << (UINT - 73)) | (1L << (ULONG - 73)) | (1L << (UNMANAGED - 73)) | (1L << (UNSAFE - 73)) | (1L << (USHORT - 73)) | (1L << (VAR - 73)) | (1L << (VIRTUAL - 73)) | (1L << (VOID - 73)) | (1L << (VOLATILE - 73)) | (1L << (WHEN - 73)) | (1L << (WHERE - 73)) | (1L << (YIELD - 73)) | (1L << (IDENTIFIER - 73)) | (1L << (OPEN_BRACKET - 73)) | (1L << (OPEN_PARENS - 73)))) != 0)) {
				{
				{
				State = 1992; struct_member_declaration();
				}
				}
				State = 1997;
				ErrorHandler.Sync(this);
	...
	public Struct_member_declarationContext struct_member_declaration() {
		...
		try {
			...
			case 1:
				{
				State = 2003; all_member_modifiers();
				}
				break;
			}
			State = 2016;
			...
			case OPEN_PARENS:
				{
				State = 2006; common_member_declaration();
				}
				break;
			case FIXED:
				{
				State = 2007; Match(FIXED);
				State = 2008; type_();
				State = 2010;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				do {
					{
					{
					State = 2009; fixed_size_buffer_declarator();
					}
					}
					State = 2012;
					ErrorHandler.Sync(this);
	...
	public Rank_specifierContext rank_specifier() {
		...
		try {
			...
			State = 2037; Match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (NULL_ - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (PARTIAL - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (SIZEOF - 64)) | (1L << (STRING - 64)) | (1L << (THIS - 64)) | (1L << (TRUE - 64)) | (1L << (TYPEOF - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNCHECKED - 64)) | (1L << (UNMANAGED - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (LITERAL_ACCESS - 64)) | (1L << (INTEGER_LITERAL - 64)) | (1L << (HEX_INTEGER_LITERAL - 64)) | (1L << (BIN_INTEGER_LITERAL - 64)) | (1L << (REAL_LITERAL - 64)) | (1L << (CHARACTER_LITERAL - 64)) | (1L << (REGULAR_STRING - 64)) | (1L << (VERBATIUM_STRING - 64)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 64)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 64)) | (1L << (OPEN_BRACE - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (OPEN_PARENS - 129)) | (1L << (PLUS - 129)) | (1L << (MINUS - 129)) | (1L << (STAR - 129)) | (1L << (AMP - 129)) | (1L << (CARET - 129)) | (1L << (BANG - 129)) | (1L << (TILDE - 129)) | (1L << (OP_INC - 129)) | (1L << (OP_DEC - 129)) | (1L << (OP_RANGE - 129)))) != 0)) {
				...
				while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						State = 2042; variable_initializer();
						}
						} 
					}
					State = 2047;
	...
	public Variant_type_parameter_listContext variant_type_parameter_list() {
		...
		try {
			...
			while (_la==COMMA) {
				...
				State = 2058; variant_type_parameter();
				}
				}
				State = 2063;
				ErrorHandler.Sync(this);
	...
	public Variant_type_parameterContext variant_type_parameter() {
		...
		try {
			...
			if (_la==IN || _la==OUT) {
				{
				State = 2069; variance_annotation();
				}
			}
	...
	public Interface_baseContext interface_base() {
		...
		try {
			...
			State = 2077; interface_type_list();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Interface_bodyContext interface_body() {
		...
		try {
			...
			while (((((_la - 10)) & ~0x3f) == 0 && ((1L << (_la - 10)) & ((1L << (ADD - 10)) | (1L << (ALIAS - 10)) | (1L << (ARGLIST - 10)) | (1L << (ASCENDING - 10)) | (1L << (ASYNC - 10)) | (1L << (AWAIT - 10)) | (1L << (BOOL - 10)) | (1L << (BY - 10)) | (1L << (BYTE - 10)) | (1L << (CHAR - 10)) | (1L << (DECIMAL - 10)) | (1L << (DESCENDING - 10)) | (1L << (DOUBLE - 10)) | (1L << (DYNAMIC - 10)) | (1L << (EQUALS - 10)) | (1L << (EVENT - 10)) | (1L << (FLOAT - 10)) | (1L << (FROM - 10)) | (1L << (GET - 10)) | (1L << (GROUP - 10)) | (1L << (INT - 10)) | (1L << (INTO - 10)) | (1L << (JOIN - 10)) | (1L << (LET - 10)) | (1L << (LONG - 10)) | (1L << (NAMEOF - 10)) | (1L << (NEW - 10)) | (1L << (OBJECT - 10)) | (1L << (ON - 10)) | (1L << (ORDERBY - 10)))) != 0) || ((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (PARTIAL - 75)) | (1L << (READONLY - 75)) | (1L << (REF - 75)) | (1L << (REMOVE - 75)) | (1L << (SBYTE - 75)) | (1L << (SELECT - 75)) | (1L << (SET - 75)) | (1L << (SHORT - 75)) | (1L << (STRING - 75)) | (1L << (UINT - 75)) | (1L << (ULONG - 75)) | (1L << (UNMANAGED - 75)) | (1L << (UNSAFE - 75)) | (1L << (USHORT - 75)) | (1L << (VAR - 75)) | (1L << (VOID - 75)) | (1L << (WHEN - 75)) | (1L << (WHERE - 75)) | (1L << (YIELD - 75)) | (1L << (IDENTIFIER - 75)) | (1L << (OPEN_BRACKET - 75)) | (1L << (OPEN_PARENS - 75)))) != 0)) {
				{
				{
				State = 2080; interface_member_declaration();
				}
				}
				State = 2085;
				ErrorHandler.Sync(this);
	...
	public Interface_member_declarationContext interface_member_declaration() {
		...
		try {
			...
			case 1:
				...
				case 1:
					{
					State = 2097; Match(REF);
					}
					break;
				case 2:
					{
					State = 2098; Match(REF);
					State = 2099; Match(READONLY);
					}
					break;
				case 3:
					{
					State = 2100; Match(READONLY);
					State = 2101; Match(REF);
					}
					break;
				}
				State = 2104; type_();
				...
				case 1:
					{
					State = 2105; identifier();
					State = 2107;
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
					if (_la==LT) {
						{
						State = 2106; type_parameter_list();
						}
					}

					State = 2109; Match(OPEN_PARENS);
					State = 2111;
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
					if (((((_la - 10)) & ~0x3f) == 0 && ((1L << (_la - 10)) & ((1L << (ADD - 10)) | (1L << (ALIAS - 10)) | (1L << (ARGLIST - 10)) | (1L << (ASCENDING - 10)) | (1L << (ASYNC - 10)) | (1L << (AWAIT - 10)) | (1L << (BOOL - 10)) | (1L << (BY - 10)) | (1L << (BYTE - 10)) | (1L << (CHAR - 10)) | (1L << (DECIMAL - 10)) | (1L << (DESCENDING - 10)) | (1L << (DOUBLE - 10)) | (1L << (DYNAMIC - 10)) | (1L << (EQUALS - 10)) | (1L << (FLOAT - 10)) | (1L << (FROM - 10)) | (1L << (GET - 10)) | (1L << (GROUP - 10)) | (1L << (IN - 10)) | (1L << (INT - 10)) | (1L << (INTO - 10)) | (1L << (JOIN - 10)) | (1L << (LET - 10)) | (1L << (LONG - 10)) | (1L << (NAMEOF - 10)) | (1L << (OBJECT - 10)) | (1L << (ON - 10)) | (1L << (ORDERBY - 10)) | (1L << (OUT - 10)))) != 0) || ((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & ((1L << (PARAMS - 74)) | (1L << (PARTIAL - 74)) | (1L << (REF - 74)) | (1L << (REMOVE - 74)) | (1L << (SBYTE - 74)) | (1L << (SELECT - 74)) | (1L << (SET - 74)) | (1L << (SHORT - 74)) | (1L << (STRING - 74)) | (1L << (THIS - 74)) | (1L << (UINT - 74)) | (1L << (ULONG - 74)) | (1L << (UNMANAGED - 74)) | (1L << (USHORT - 74)) | (1L << (VAR - 74)) | (1L << (VOID - 74)) | (1L << (WHEN - 74)) | (1L << (WHERE - 74)) | (1L << (YIELD - 74)) | (1L << (IDENTIFIER - 74)) | (1L << (OPEN_BRACKET - 74)) | (1L << (OPEN_PARENS - 74)))) != 0)) {
						{
						State = 2110; formal_parameter_list();
						}
					}

					State = 2113; Match(CLOSE_PARENS);
					State = 2115;
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
					if (_la==WHERE) {
						{
						State = 2114; type_parameter_constraints_clauses();
						}
					}
				...
				case 2:
					{
					State = 2119; identifier();
					State = 2120; Match(OPEN_BRACE);
					State = 2121; interface_accessors();
					State = 2122; Match(CLOSE_BRACE);
					}
					break;
				case 3:
					{
					State = 2124; Match(THIS);
					State = 2125; Match(OPEN_BRACKET);
					State = 2126; formal_parameter_list();
					State = 2127; Match(CLOSE_BRACKET);
					State = 2128; Match(OPEN_BRACE);
					State = 2129; interface_accessors();
					State = 2130; Match(CLOSE_BRACE);
					}
					break;
				}
				}
			...
			case 2:
				...
				if (_la==UNSAFE) {
					{
					State = 2134; Match(UNSAFE);
					}
				}

				State = 2137; Match(VOID);
				...
				if (_la==LT) {
					{
					State = 2139; type_parameter_list();
					}
				}

				State = 2142; Match(OPEN_PARENS);
				State = 2144;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (((((_la - 10)) & ~0x3f) == 0 && ((1L << (_la - 10)) & ((1L << (ADD - 10)) | (1L << (ALIAS - 10)) | (1L << (ARGLIST - 10)) | (1L << (ASCENDING - 10)) | (1L << (ASYNC - 10)) | (1L << (AWAIT - 10)) | (1L << (BOOL - 10)) | (1L << (BY - 10)) | (1L << (BYTE - 10)) | (1L << (CHAR - 10)) | (1L << (DECIMAL - 10)) | (1L << (DESCENDING - 10)) | (1L << (DOUBLE - 10)) | (1L << (DYNAMIC - 10)) | (1L << (EQUALS - 10)) | (1L << (FLOAT - 10)) | (1L << (FROM - 10)) | (1L << (GET - 10)) | (1L << (GROUP - 10)) | (1L << (IN - 10)) | (1L << (INT - 10)) | (1L << (INTO - 10)) | (1L << (JOIN - 10)) | (1L << (LET - 10)) | (1L << (LONG - 10)) | (1L << (NAMEOF - 10)) | (1L << (OBJECT - 10)) | (1L << (ON - 10)) | (1L << (ORDERBY - 10)) | (1L << (OUT - 10)))) != 0) || ((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & ((1L << (PARAMS - 74)) | (1L << (PARTIAL - 74)) | (1L << (REF - 74)) | (1L << (REMOVE - 74)) | (1L << (SBYTE - 74)) | (1L << (SELECT - 74)) | (1L << (SET - 74)) | (1L << (SHORT - 74)) | (1L << (STRING - 74)) | (1L << (THIS - 74)) | (1L << (UINT - 74)) | (1L << (ULONG - 74)) | (1L << (UNMANAGED - 74)) | (1L << (USHORT - 74)) | (1L << (VAR - 74)) | (1L << (VOID - 74)) | (1L << (WHEN - 74)) | (1L << (WHERE - 74)) | (1L << (YIELD - 74)) | (1L << (IDENTIFIER - 74)) | (1L << (OPEN_BRACKET - 74)) | (1L << (OPEN_PARENS - 74)))) != 0)) {
					{
					State = 2143; formal_parameter_list();
					}
				}

				State = 2146; Match(CLOSE_PARENS);
				State = 2148;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==WHERE) {
					{
					State = 2147; type_parameter_constraints_clauses();
					}
				}

				State = 2150; Match(SEMICOLON);
				}
				break;
			case 3:
				{
				State = 2152; Match(EVENT);
				State = 2153; type_();
				State = 2154; identifier();
	...
	public Interface_accessorsContext interface_accessors() {
		...
		try {
			...
			case GET:
				{
				State = 2162; Match(GET);
				State = 2163; Match(SEMICOLON);
				State = 2169;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
			...
			case SET:
				...
				if (_la==GET || _la==OPEN_BRACKET) {
					...
					if (_la==OPEN_BRACKET) {
						{
						State = 2173; attributes();
						}
					}

					State = 2176; Match(GET);
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BY) | (1L << DESCENDING) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INTO) | (1L << JOIN) | (1L << LET))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (PARTIAL - 64)) | (1L << (REMOVE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (UNMANAGED - 64)) | (1L << (VAR - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (OPEN_BRACKET - 64)))) != 0)) {
				...
				while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
					if ( _alt==1 ) {
						...
						State = 2188; enum_member_declaration();
						}
						} 
					}
					State = 2193;
	...
	public Enum_member_declarationContext enum_member_declaration() {
		...
		try {
			...
			if (_la==ASSIGNMENT) {
				{
				State = 2205; Match(ASSIGNMENT);
				State = 2206; expression();
				}
			}
	...
	public Global_attribute_sectionContext global_attribute_section() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2209; Match(OPEN_BRACKET);
			State = 2210; global_attribute_target();
			State = 2211; Match(COLON);
			State = 2212; attribute_list();
			State = 2214;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==COMMA) {
			...
			State = 2216; Match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Attribute_sectionContext attribute_section() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2227; Match(OPEN_BRACKET);
			State = 2231;
			ErrorHandler.Sync(this);
			switch ( Interpreter.AdaptivePredict(TokenStream,276,Context) ) {
			case 1:
				{
				State = 2228; attribute_target();
				State = 2229; Match(COLON);
				}
				break;
			}
			State = 2233; attribute_list();
			State = 2235;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==COMMA) {
			...
			State = 2237; Match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public AttributeContext attribute() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2251; namespace_or_type_name();
			State = 2264;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==OPEN_PARENS) {
				{
				State = 2252; Match(OPEN_PARENS);
				State = 2261;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (NULL_ - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (PARTIAL - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (SIZEOF - 64)) | (1L << (STRING - 64)) | (1L << (THIS - 64)) | (1L << (TRUE - 64)) | (1L << (TYPEOF - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNCHECKED - 64)) | (1L << (UNMANAGED - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (LITERAL_ACCESS - 64)) | (1L << (INTEGER_LITERAL - 64)) | (1L << (HEX_INTEGER_LITERAL - 64)) | (1L << (BIN_INTEGER_LITERAL - 64)) | (1L << (REAL_LITERAL - 64)) | (1L << (CHARACTER_LITERAL - 64)) | (1L << (REGULAR_STRING - 64)) | (1L << (VERBATIUM_STRING - 64)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 64)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (OPEN_PARENS - 129)) | (1L << (PLUS - 129)) | (1L << (MINUS - 129)) | (1L << (STAR - 129)) | (1L << (AMP - 129)) | (1L << (CARET - 129)) | (1L << (BANG - 129)) | (1L << (TILDE - 129)) | (1L << (OP_INC - 129)) | (1L << (OP_DEC - 129)) | (1L << (OP_RANGE - 129)))) != 0)) {
	...
	public Attribute_argumentContext attribute_argument() {
		...
		try {
			...
			case 1:
				...
				State = 2267; Match(COLON);
				}
				break;
			}
			State = 2271; expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			case IDENTIFIER:
				...
				while (_la==OPEN_BRACKET || _la==INTERR) {
					...
					case OPEN_BRACKET:
						{
						State = 2277; rank_specifier();
						}
						break;
					case INTERR:
						{
						State = 2278; Match(INTERR);
						}
						break;
					default:
						throw new NoViableAltException(this);
				...
				State = 2284; Match(STAR);
				}
				break;
			case VOID:
				EnterOuterAlt(_localctx, 2);
				{
				State = 2286; Match(VOID);
				State = 2287; Match(STAR);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Fixed_pointer_declaratorsContext fixed_pointer_declarators() {
		...
		try {
			...
			while (_la==COMMA) {
				...
				State = 2292; fixed_pointer_declarator();
				}
				}
				State = 2297;
				ErrorHandler.Sync(this);
	...
	public Fixed_pointer_declaratorContext fixed_pointer_declarator() {
		...
		try {
			...
			State = 2299; Match(ASSIGNMENT);
			State = 2300; fixed_pointer_initializer();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Fixed_pointer_initializerContext fixed_pointer_initializer() {
		...
		try {
			...
			case STACKALLOC:
				EnterOuterAlt(_localctx, 2);
				{
				State = 2306; stackalloc_initializer();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Fixed_size_buffer_declaratorContext fixed_size_buffer_declarator() {
		...
		try {
			...
			State = 2310; Match(OPEN_BRACKET);
			State = 2311; expression();
			State = 2312; Match(CLOSE_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Stackalloc_initializerContext stackalloc_initializer() {
		...
		try {
			...
			case 1:
				EnterOuterAlt(_localctx, 1);
				{
				State = 2314; Match(STACKALLOC);
				State = 2315; type_();
				State = 2316; Match(OPEN_BRACKET);
				State = 2317; expression();
				State = 2318; Match(CLOSE_BRACKET);
				}
				break;
			case 2:
				EnterOuterAlt(_localctx, 2);
				{
				State = 2320; Match(STACKALLOC);
				State = 2322;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				...
				State = 2324; Match(OPEN_BRACKET);
				State = 2326;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (NULL_ - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (PARTIAL - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (SIZEOF - 64)) | (1L << (STRING - 64)) | (1L << (THIS - 64)) | (1L << (TRUE - 64)) | (1L << (TYPEOF - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNCHECKED - 64)) | (1L << (UNMANAGED - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (LITERAL_ACCESS - 64)) | (1L << (INTEGER_LITERAL - 64)) | (1L << (HEX_INTEGER_LITERAL - 64)) | (1L << (BIN_INTEGER_LITERAL - 64)) | (1L << (REAL_LITERAL - 64)) | (1L << (CHARACTER_LITERAL - 64)) | (1L << (REGULAR_STRING - 64)) | (1L << (VERBATIUM_STRING - 64)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 64)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (OPEN_PARENS - 129)) | (1L << (PLUS - 129)) | (1L << (MINUS - 129)) | (1L << (STAR - 129)) | (1L << (AMP - 129)) | (1L << (CARET - 129)) | (1L << (BANG - 129)) | (1L << (TILDE - 129)) | (1L << (OP_INC - 129)) | (1L << (OP_DEC - 129)) | (1L << (OP_RANGE - 129)))) != 0)) {
					{
					State = 2325; expression();
					}
				}

				State = 2328; Match(CLOSE_BRACKET);
				State = 2329; Match(OPEN_BRACE);
	...
	public Right_arrowContext right_arrow() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2345; _localctx.first = Match(ASSIGNMENT);
			State = 2346; _localctx.second = Match(GT);
			State = 2347;
	...
	public Right_shiftContext right_shift() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2349; _localctx.first = Match(GT);
			State = 2350; _localctx.second = Match(GT);
			State = 2351;
			if (!((_localctx.first!=null?_localctx.first.TokenIndex:0) + 1 == (_localctx.second!=null?_localctx.second.TokenIndex:0))) throw new FailedPredicateException(this, "$first.index + 1 == $second.index");
			}
		}
	...
	public Right_shift_assignmentContext right_shift_assignment() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2353; _localctx.first = Match(GT);
			State = 2354; _localctx.second = Match(OP_GE);
			State = 2355;
			if (!((_localctx.first!=null?_localctx.first.TokenIndex:0) + 1 == (_localctx.second!=null?_localctx.second.TokenIndex:0))) throw new FailedPredicateException(this, "$first.index + 1 == $second.index");
			}
		}
	...
	public LiteralContext literal() {
		...
		try {
			...
			case INTERPOLATED_VERBATIUM_STRING_START:
				EnterOuterAlt(_localctx, 2);
				{
				State = 2358; string_literal();
				}
				break;
			case INTEGER_LITERAL:
				EnterOuterAlt(_localctx, 3);
				{
				State = 2359; Match(INTEGER_LITERAL);
				}
				break;
			case HEX_INTEGER_LITERAL:
				EnterOuterAlt(_localctx, 4);
				{
				State = 2360; Match(HEX_INTEGER_LITERAL);
				}
				break;
			case BIN_INTEGER_LITERAL:
				EnterOuterAlt(_localctx, 5);
				{
				State = 2361; Match(BIN_INTEGER_LITERAL);
				}
				break;
			case REAL_LITERAL:
				EnterOuterAlt(_localctx, 6);
				{
				State = 2362; Match(REAL_LITERAL);
				}
				break;
			case CHARACTER_LITERAL:
				EnterOuterAlt(_localctx, 7);
				{
				State = 2363; Match(CHARACTER_LITERAL);
				}
				break;
			case NULL_:
				EnterOuterAlt(_localctx, 8);
				{
				State = 2364; Match(NULL_);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public String_literalContext string_literal() {
		...
		try {
			...
			case INTERPOLATED_REGULAR_STRING_START:
				EnterOuterAlt(_localctx, 1);
				{
				State = 2369; interpolated_regular_string();
				}
				break;
			case INTERPOLATED_VERBATIUM_STRING_START:
				EnterOuterAlt(_localctx, 2);
				{
				State = 2370; interpolated_verbatium_string();
				}
				break;
			case REGULAR_STRING:
				EnterOuterAlt(_localctx, 3);
				{
				State = 2371; Match(REGULAR_STRING);
				}
				break;
			case VERBATIUM_STRING:
				EnterOuterAlt(_localctx, 4);
				{
				State = 2372; Match(VERBATIUM_STRING);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Interpolated_regular_stringContext interpolated_regular_string() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2375; Match(INTERPOLATED_REGULAR_STRING_START);
			State = 2379;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (NULL_ - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (PARTIAL - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (SIZEOF - 64)) | (1L << (STRING - 64)) | (1L << (THIS - 64)) | (1L << (TRUE - 64)) | (1L << (TYPEOF - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNCHECKED - 64)) | (1L << (UNMANAGED - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (LITERAL_ACCESS - 64)) | (1L << (INTEGER_LITERAL - 64)) | (1L << (HEX_INTEGER_LITERAL - 64)) | (1L << (BIN_INTEGER_LITERAL - 64)) | (1L << (REAL_LITERAL - 64)) | (1L << (CHARACTER_LITERAL - 64)) | (1L << (REGULAR_STRING - 64)) | (1L << (VERBATIUM_STRING - 64)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 64)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (OPEN_PARENS - 129)) | (1L << (PLUS - 129)) | (1L << (MINUS - 129)) | (1L << (STAR - 129)) | (1L << (AMP - 129)) | (1L << (CARET - 129)) | (1L << (BANG - 129)) | (1L << (TILDE - 129)) | (1L << (OP_INC - 129)) | (1L << (OP_DEC - 129)) | (1L << (OP_RANGE - 129)) | (1L << (DOUBLE_CURLY_INSIDE - 129)) | (1L << (REGULAR_CHAR_INSIDE - 129)) | (1L << (REGULAR_STRING_INSIDE - 129)))) != 0)) {
				{
				{
				State = 2376; interpolated_regular_string_part();
				}
				}
				State = 2381;
				ErrorHandler.Sync(this);
			...
			State = 2382; Match(DOUBLE_QUOTE_INSIDE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Interpolated_verbatium_stringContext interpolated_verbatium_string() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2384; Match(INTERPOLATED_VERBATIUM_STRING_START);
			State = 2388;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (NULL_ - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (PARTIAL - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (SIZEOF - 64)) | (1L << (STRING - 64)) | (1L << (THIS - 64)) | (1L << (TRUE - 64)) | (1L << (TYPEOF - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNCHECKED - 64)) | (1L << (UNMANAGED - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (LITERAL_ACCESS - 64)) | (1L << (INTEGER_LITERAL - 64)) | (1L << (HEX_INTEGER_LITERAL - 64)) | (1L << (BIN_INTEGER_LITERAL - 64)) | (1L << (REAL_LITERAL - 64)) | (1L << (CHARACTER_LITERAL - 64)) | (1L << (REGULAR_STRING - 64)) | (1L << (VERBATIUM_STRING - 64)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 64)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (OPEN_PARENS - 129)) | (1L << (PLUS - 129)) | (1L << (MINUS - 129)) | (1L << (STAR - 129)) | (1L << (AMP - 129)) | (1L << (CARET - 129)) | (1L << (BANG - 129)) | (1L << (TILDE - 129)) | (1L << (OP_INC - 129)) | (1L << (OP_DEC - 129)) | (1L << (OP_RANGE - 129)) | (1L << (DOUBLE_CURLY_INSIDE - 129)) | (1L << (VERBATIUM_DOUBLE_QUOTE_INSIDE - 129)) | (1L << (VERBATIUM_INSIDE_STRING - 129)))) != 0)) {
				{
				{
				State = 2385; interpolated_verbatium_string_part();
				}
				}
				State = 2390;
				ErrorHandler.Sync(this);
			...
			State = 2391; Match(DOUBLE_QUOTE_INSIDE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Interpolated_regular_string_partContext interpolated_regular_string_part() {
		...
		try {
			...
			case OP_RANGE:
				EnterOuterAlt(_localctx, 1);
				{
				State = 2393; interpolated_string_expression();
				}
				break;
			case DOUBLE_CURLY_INSIDE:
				EnterOuterAlt(_localctx, 2);
				{
				State = 2394; Match(DOUBLE_CURLY_INSIDE);
				}
				break;
			case REGULAR_CHAR_INSIDE:
				EnterOuterAlt(_localctx, 3);
				{
				State = 2395; Match(REGULAR_CHAR_INSIDE);
				}
				break;
			case REGULAR_STRING_INSIDE:
				EnterOuterAlt(_localctx, 4);
				{
				State = 2396; Match(REGULAR_STRING_INSIDE);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Interpolated_verbatium_string_partContext interpolated_verbatium_string_part() {
		...
		try {
			...
			case OP_RANGE:
				EnterOuterAlt(_localctx, 1);
				{
				State = 2399; interpolated_string_expression();
				}
				break;
			case DOUBLE_CURLY_INSIDE:
				EnterOuterAlt(_localctx, 2);
				{
				State = 2400; Match(DOUBLE_CURLY_INSIDE);
				}
				break;
			case VERBATIUM_DOUBLE_QUOTE_INSIDE:
				EnterOuterAlt(_localctx, 3);
				{
				State = 2401; Match(VERBATIUM_DOUBLE_QUOTE_INSIDE);
				}
				break;
			case VERBATIUM_INSIDE_STRING:
				EnterOuterAlt(_localctx, 4);
				{
				State = 2402; Match(VERBATIUM_INSIDE_STRING);
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			if (_la==COLON) {
				...
				do {
					{
					{
					State = 2414; Match(FORMAT_STRING);
					}
					}
					State = 2417;
					ErrorHandler.Sync(this);
	...
	public Class_definitionContext class_definition() {
		...
		try {
			...
			if (_la==LT) {
				{
				State = 2425; type_parameter_list();
				}
			}
			...
			if (_la==WHERE) {
				{
				State = 2431; type_parameter_constraints_clauses();
				}
			}

			State = 2434; class_body();
			State = 2436;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==SEMICOLON) {
				{
				State = 2435; Match(SEMICOLON);
				}
			}
	...
	public Struct_definitionContext struct_definition() {
		...
		try {
			...
			State = 2441; Match(STRUCT);
			State = 2442; identifier();
			State = 2444;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==LT) {
				{
				State = 2443; type_parameter_list();
				}
			}
			...
			if (_la==WHERE) {
				{
				State = 2449; type_parameter_constraints_clauses();
				}
			}

			State = 2452; struct_body();
			State = 2454;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==SEMICOLON) {
				{
				State = 2453; Match(SEMICOLON);
				}
			}
	...
	public Interface_definitionContext interface_definition() {
		...
		try {
			...
			if (_la==LT) {
				{
				State = 2458; variant_type_parameter_list();
				}
			}
			...
			if (_la==WHERE) {
				{
				State = 2464; type_parameter_constraints_clauses();
				}
			}

			State = 2467; class_body();
			State = 2469;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==SEMICOLON) {
				{
				State = 2468; Match(SEMICOLON);
				}
			}
	...
	public Enum_definitionContext enum_definition() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2471; Match(ENUM);
			State = 2472; identifier();
			State = 2474;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==COLON) {
				{
				State = 2473; enum_base();
				}
			}

			State = 2476; enum_body();
			State = 2478;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==SEMICOLON) {
				{
				State = 2477; Match(SEMICOLON);
				}
			}
	...
	public Delegate_definitionContext delegate_definition() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2480; Match(DELEGATE);
			State = 2481; return_type();
			State = 2482; identifier();
			State = 2484;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==LT) {
				{
				State = 2483; variant_type_parameter_list();
				}
			}

			State = 2486; Match(OPEN_PARENS);
			State = 2488;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (((((_la - 10)) & ~0x3f) == 0 && ((1L << (_la - 10)) & ((1L << (ADD - 10)) | (1L << (ALIAS - 10)) | (1L << (ARGLIST - 10)) | (1L << (ASCENDING - 10)) | (1L << (ASYNC - 10)) | (1L << (AWAIT - 10)) | (1L << (BOOL - 10)) | (1L << (BY - 10)) | (1L << (BYTE - 10)) | (1L << (CHAR - 10)) | (1L << (DECIMAL - 10)) | (1L << (DESCENDING - 10)) | (1L << (DOUBLE - 10)) | (1L << (DYNAMIC - 10)) | (1L << (EQUALS - 10)) | (1L << (FLOAT - 10)) | (1L << (FROM - 10)) | (1L << (GET - 10)) | (1L << (GROUP - 10)) | (1L << (IN - 10)) | (1L << (INT - 10)) | (1L << (INTO - 10)) | (1L << (JOIN - 10)) | (1L << (LET - 10)) | (1L << (LONG - 10)) | (1L << (NAMEOF - 10)) | (1L << (OBJECT - 10)) | (1L << (ON - 10)) | (1L << (ORDERBY - 10)) | (1L << (OUT - 10)))) != 0) || ((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & ((1L << (PARAMS - 74)) | (1L << (PARTIAL - 74)) | (1L << (REF - 74)) | (1L << (REMOVE - 74)) | (1L << (SBYTE - 74)) | (1L << (SELECT - 74)) | (1L << (SET - 74)) | (1L << (SHORT - 74)) | (1L << (STRING - 74)) | (1L << (THIS - 74)) | (1L << (UINT - 74)) | (1L << (ULONG - 74)) | (1L << (UNMANAGED - 74)) | (1L << (USHORT - 74)) | (1L << (VAR - 74)) | (1L << (VOID - 74)) | (1L << (WHEN - 74)) | (1L << (WHERE - 74)) | (1L << (YIELD - 74)) | (1L << (IDENTIFIER - 74)) | (1L << (OPEN_BRACKET - 74)) | (1L << (OPEN_PARENS - 74)))) != 0)) {
				{
				State = 2487; formal_parameter_list();
				}
			}

			State = 2490; Match(CLOSE_PARENS);
			State = 2492;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==WHERE) {
				{
				State = 2491; type_parameter_constraints_clauses();
				}
			}

			State = 2494; Match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Event_declarationContext event_declaration() {
		...
		try {
			...
			case 1:
				{
				State = 2498; variable_declarators();
				State = 2499; Match(SEMICOLON);
				}
				break;
			case 2:
				{
				State = 2501; member_name();
				State = 2502; Match(OPEN_BRACE);
				State = 2503; event_accessor_declarations();
				State = 2504; Match(CLOSE_BRACE);
				}
				break;
			}
			}
	...
	public Field_declarationContext field_declaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2508; variable_declarators();
			State = 2509; Match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Property_declarationContext property_declaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2511; member_name();
			State = 2525;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case OPEN_BRACE:
				{
				State = 2512; Match(OPEN_BRACE);
				State = 2513; accessor_declarations();
				State = 2514; Match(CLOSE_BRACE);
				State = 2519;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==ASSIGNMENT) {
					{
					State = 2515; Match(ASSIGNMENT);
					State = 2516; variable_initializer();
					State = 2517; Match(SEMICOLON);
					}
				}
			...
			case ASSIGNMENT:
				{
				State = 2521; right_arrow();
				State = 2522; throwable_expression();
				State = 2523; Match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Constant_declarationContext constant_declaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2527; Match(CONST);
			State = 2528; type_();
			State = 2529; constant_declarators();
			State = 2530; Match(SEMICOLON);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Indexer_declarationContext indexer_declaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2532; Match(THIS);
			State = 2533; Match(OPEN_BRACKET);
			State = 2534; formal_parameter_list();
			State = 2535; Match(CLOSE_BRACKET);
			State = 2544;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case OPEN_BRACE:
				{
				State = 2536; Match(OPEN_BRACE);
				State = 2537; accessor_declarations();
				State = 2538; Match(CLOSE_BRACE);
				}
				break;
			case ASSIGNMENT:
				{
				State = 2540; right_arrow();
				State = 2541; throwable_expression();
				State = 2542; Match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Destructor_definitionContext destructor_definition() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2546; Match(TILDE);
			State = 2547; identifier();
			State = 2548; Match(OPEN_PARENS);
			State = 2549; Match(CLOSE_PARENS);
			State = 2550; body();
			}
		}
		catch (RecognitionException re) {
	...
	public Constructor_declarationContext constructor_declaration() {
		...
		try {
			...
			if (((((_la - 10)) & ~0x3f) == 0 && ((1L << (_la - 10)) & ((1L << (ADD - 10)) | (1L << (ALIAS - 10)) | (1L << (ARGLIST - 10)) | (1L << (ASCENDING - 10)) | (1L << (ASYNC - 10)) | (1L << (AWAIT - 10)) | (1L << (BOOL - 10)) | (1L << (BY - 10)) | (1L << (BYTE - 10)) | (1L << (CHAR - 10)) | (1L << (DECIMAL - 10)) | (1L << (DESCENDING - 10)) | (1L << (DOUBLE - 10)) | (1L << (DYNAMIC - 10)) | (1L << (EQUALS - 10)) | (1L << (FLOAT - 10)) | (1L << (FROM - 10)) | (1L << (GET - 10)) | (1L << (GROUP - 10)) | (1L << (IN - 10)) | (1L << (INT - 10)) | (1L << (INTO - 10)) | (1L << (JOIN - 10)) | (1L << (LET - 10)) | (1L << (LONG - 10)) | (1L << (NAMEOF - 10)) | (1L << (OBJECT - 10)) | (1L << (ON - 10)) | (1L << (ORDERBY - 10)) | (1L << (OUT - 10)))) != 0) || ((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & ((1L << (PARAMS - 74)) | (1L << (PARTIAL - 74)) | (1L << (REF - 74)) | (1L << (REMOVE - 74)) | (1L << (SBYTE - 74)) | (1L << (SELECT - 74)) | (1L << (SET - 74)) | (1L << (SHORT - 74)) | (1L << (STRING - 74)) | (1L << (THIS - 74)) | (1L << (UINT - 74)) | (1L << (ULONG - 74)) | (1L << (UNMANAGED - 74)) | (1L << (USHORT - 74)) | (1L << (VAR - 74)) | (1L << (VOID - 74)) | (1L << (WHEN - 74)) | (1L << (WHERE - 74)) | (1L << (YIELD - 74)) | (1L << (IDENTIFIER - 74)) | (1L << (OPEN_BRACKET - 74)) | (1L << (OPEN_PARENS - 74)))) != 0)) {
				{
				State = 2554; formal_parameter_list();
				}
			}

			State = 2557; Match(CLOSE_PARENS);
			State = 2559;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==COLON) {
				{
				State = 2558; constructor_initializer();
				}
			}
	...
	public Method_declarationContext method_declaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2563; method_member_name();
			State = 2565;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==LT) {
				{
				State = 2564; type_parameter_list();
				}
			}

			State = 2567; Match(OPEN_PARENS);
			State = 2569;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (((((_la - 10)) & ~0x3f) == 0 && ((1L << (_la - 10)) & ((1L << (ADD - 10)) | (1L << (ALIAS - 10)) | (1L << (ARGLIST - 10)) | (1L << (ASCENDING - 10)) | (1L << (ASYNC - 10)) | (1L << (AWAIT - 10)) | (1L << (BOOL - 10)) | (1L << (BY - 10)) | (1L << (BYTE - 10)) | (1L << (CHAR - 10)) | (1L << (DECIMAL - 10)) | (1L << (DESCENDING - 10)) | (1L << (DOUBLE - 10)) | (1L << (DYNAMIC - 10)) | (1L << (EQUALS - 10)) | (1L << (FLOAT - 10)) | (1L << (FROM - 10)) | (1L << (GET - 10)) | (1L << (GROUP - 10)) | (1L << (IN - 10)) | (1L << (INT - 10)) | (1L << (INTO - 10)) | (1L << (JOIN - 10)) | (1L << (LET - 10)) | (1L << (LONG - 10)) | (1L << (NAMEOF - 10)) | (1L << (OBJECT - 10)) | (1L << (ON - 10)) | (1L << (ORDERBY - 10)) | (1L << (OUT - 10)))) != 0) || ((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & ((1L << (PARAMS - 74)) | (1L << (PARTIAL - 74)) | (1L << (REF - 74)) | (1L << (REMOVE - 74)) | (1L << (SBYTE - 74)) | (1L << (SELECT - 74)) | (1L << (SET - 74)) | (1L << (SHORT - 74)) | (1L << (STRING - 74)) | (1L << (THIS - 74)) | (1L << (UINT - 74)) | (1L << (ULONG - 74)) | (1L << (UNMANAGED - 74)) | (1L << (USHORT - 74)) | (1L << (VAR - 74)) | (1L << (VOID - 74)) | (1L << (WHEN - 74)) | (1L << (WHERE - 74)) | (1L << (YIELD - 74)) | (1L << (IDENTIFIER - 74)) | (1L << (OPEN_BRACKET - 74)) | (1L << (OPEN_PARENS - 74)))) != 0)) {
				{
				State = 2568; formal_parameter_list();
				}
			}

			State = 2571; Match(CLOSE_PARENS);
			State = 2573;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==WHERE) {
				{
				State = 2572; type_parameter_constraints_clauses();
				}
			}
			...
			case SEMICOLON:
				{
				State = 2575; method_body();
				}
				break;
			case ASSIGNMENT:
				{
				State = 2576; right_arrow();
				State = 2577; throwable_expression();
				State = 2578; Match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if (_la==LT) {
						{
						State = 2589; type_argument_list();
						}
					}

					State = 2592; Match(DOT);
					State = 2593; identifier();
					}
					} 
				}
				State = 2598;
	...
	public Operator_declarationContext operator_declaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2599; Match(OPERATOR);
			State = 2600; overloadable_operator();
			State = 2601; Match(OPEN_PARENS);
			State = 2603;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==IN) {
			...
			State = 2605; arg_declaration();
			State = 2611;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==COMMA) {
				{
				State = 2606; Match(COMMA);
				State = 2608;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (_la==IN) {
				...
				State = 2610; arg_declaration();
				}
			}

			State = 2613; Match(CLOSE_PARENS);
			State = 2619;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case OPEN_BRACE:
			...
			case ASSIGNMENT:
				{
				State = 2615; right_arrow();
				State = 2616; throwable_expression();
				State = 2617; Match(SEMICOLON);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public Arg_declarationContext arg_declaration() {
		...
		try {
			...
			{
			State = 2621; type_();
			State = 2622; identifier();
			State = 2625;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==ASSIGNMENT) {
				{
				State = 2623; Match(ASSIGNMENT);
	...
	public Method_invocationContext method_invocation() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2627; Match(OPEN_PARENS);
			State = 2629;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << IN) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (NULL_ - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (OUT - 64)) | (1L << (PARTIAL - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (SIZEOF - 64)) | (1L << (STRING - 64)) | (1L << (THIS - 64)) | (1L << (TRUE - 64)) | (1L << (TYPEOF - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNCHECKED - 64)) | (1L << (UNMANAGED - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (VOID - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (LITERAL_ACCESS - 64)) | (1L << (INTEGER_LITERAL - 64)) | (1L << (HEX_INTEGER_LITERAL - 64)) | (1L << (BIN_INTEGER_LITERAL - 64)) | (1L << (REAL_LITERAL - 64)) | (1L << (CHARACTER_LITERAL - 64)) | (1L << (REGULAR_STRING - 64)) | (1L << (VERBATIUM_STRING - 64)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 64)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (OPEN_PARENS - 129)) | (1L << (PLUS - 129)) | (1L << (MINUS - 129)) | (1L << (STAR - 129)) | (1L << (AMP - 129)) | (1L << (CARET - 129)) | (1L << (BANG - 129)) | (1L << (TILDE - 129)) | (1L << (OP_INC - 129)) | (1L << (OP_DEC - 129)) | (1L << (OP_RANGE - 129)))) != 0)) {
				{
				State = 2628; argument_list();
				}
			}

			State = 2631; Match(CLOSE_PARENS);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public Object_creation_expressionContext object_creation_expression() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 2633; Match(OPEN_PARENS);
			State = 2635;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ADD) | (1L << ALIAS) | (1L << ARGLIST) | (1L << ASCENDING) | (1L << ASYNC) | (1L << AWAIT) | (1L << BASE) | (1L << BOOL) | (1L << BY) | (1L << BYTE) | (1L << CHAR) | (1L << CHECKED) | (1L << DECIMAL) | (1L << DEFAULT) | (1L << DELEGATE) | (1L << DESCENDING) | (1L << DOUBLE) | (1L << DYNAMIC) | (1L << EQUALS) | (1L << FALSE) | (1L << FLOAT) | (1L << FROM) | (1L << GET) | (1L << GROUP) | (1L << IN) | (1L << INT) | (1L << INTO) | (1L << JOIN) | (1L << LET) | (1L << LONG))) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (NAMEOF - 64)) | (1L << (NEW - 64)) | (1L << (NULL_ - 64)) | (1L << (OBJECT - 64)) | (1L << (ON - 64)) | (1L << (ORDERBY - 64)) | (1L << (OUT - 64)) | (1L << (PARTIAL - 64)) | (1L << (REF - 64)) | (1L << (REMOVE - 64)) | (1L << (SBYTE - 64)) | (1L << (SELECT - 64)) | (1L << (SET - 64)) | (1L << (SHORT - 64)) | (1L << (SIZEOF - 64)) | (1L << (STRING - 64)) | (1L << (THIS - 64)) | (1L << (TRUE - 64)) | (1L << (TYPEOF - 64)) | (1L << (UINT - 64)) | (1L << (ULONG - 64)) | (1L << (UNCHECKED - 64)) | (1L << (UNMANAGED - 64)) | (1L << (USHORT - 64)) | (1L << (VAR - 64)) | (1L << (VOID - 64)) | (1L << (WHEN - 64)) | (1L << (WHERE - 64)) | (1L << (YIELD - 64)) | (1L << (IDENTIFIER - 64)) | (1L << (LITERAL_ACCESS - 64)) | (1L << (INTEGER_LITERAL - 64)) | (1L << (HEX_INTEGER_LITERAL - 64)) | (1L << (BIN_INTEGER_LITERAL - 64)) | (1L << (REAL_LITERAL - 64)) | (1L << (CHARACTER_LITERAL - 64)) | (1L << (REGULAR_STRING - 64)) | (1L << (VERBATIUM_STRING - 64)) | (1L << (INTERPOLATED_REGULAR_STRING_START - 64)) | (1L << (INTERPOLATED_VERBATIUM_STRING_START - 64)))) != 0) || ((((_la - 129)) & ~0x3f) == 0 && ((1L << (_la - 129)) & ((1L << (OPEN_PARENS - 129)) | (1L << (PLUS - 129)) | (1L << (MINUS - 129)) | (1L << (STAR - 129)) | (1L << (AMP - 129)) | (1L << (CARET - 129)) | (1L << (BANG - 129)) | (1L << (TILDE - 129)) | (1L << (OP_INC - 129)) | (1L << (OP_DEC - 129)) | (1L << (OP_RANGE - 129)))) != 0)) {
				{
				State = 2634; argument_list();
				}
			}

			State = 2637; Match(CLOSE_PARENS);
			State = 2639;
			ErrorHandler.Sync(this);
			switch ( Interpreter.AdaptivePredict(TokenStream,343,Context) ) {
			case 1:
				{
				State = 2638; object_or_collection_initializer();
				}
				break;
			}
			}
